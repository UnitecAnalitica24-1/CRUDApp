package mx.unitec.Viewresolvers;
...
public class JakartaViewResolver extends AbstractTemplateViewResolver
    ...
    /**
     * Creates a new {@link JakartaViewResolver}.
     *
     * @param viewClass The view's class. Required.
     */
    public JakartaViewResolver(
            final Class<? extends JakartaView> viewClass) {
     ...
     */
    public JakartaViewResolver() {
        this(JakartaView.class);
    }

    /**
     * Creates a new {@link JakartaViewResolver} that utilizes the parameter handlebars for the
     ...
     *                   Required.
     */
    public JakartaViewResolver(final Handlebars handlebars) {
        this(handlebars, JakartaView.class);
    }
    ...
    protected AbstractUrlBasedView buildView(final String viewName)
            throws Exception {
        return configure((JakartaView) super.buildView(viewName));
    }
     ...
     */
    protected AbstractUrlBasedView configure(final JakartaView view)
            throws IOException {
     ...
     */
    @Override
    public JakartaViewResolver registerHelpers(final Object helperSource) {
     ...
     */
    @Override
    public JakartaViewResolver registerHelpers(final Class<?> helperSource) {
        registry.registerHelpers(helperSource);
        return this;
    }
    ...
    @Override
    public <H> JakartaViewResolver registerHelper(final String name, final Helper<H> helper) {
        registry.registerHelper(name, helper);
        return this;
    }

    @Override
    public <H> JakartaViewResolver registerHelperMissing(final Helper<H> helper) {
        registry.registerHelperMissing(helper);
        return this;
    }

    @Override
    public JakartaViewResolver registerHelpers(final URI location) throws Exception {
        registry.registerHelpers(location);
        return this;
    }

    @Override
    public JakartaViewResolver registerHelpers(final File input) throws Exception {
        registry.registerHelpers(input);
        return this;
    }

    @Override
    public JakartaViewResolver registerHelpers(final String filename, final Reader source)
            throws Exception {
    ...
    @Override
    public JakartaViewResolver registerHelpers(final String filename, final InputStream source)
            throws Exception {
        registry.registerHelpers(filename, source);
        return this;
    }
    ...
    @Override
    public JakartaViewResolver registerHelpers(final String filename, final String source)
            throws IOException {
        registry.registerHelpers(filename, source);
        return this;
    }
     ...
     */
    public JakartaViewResolver withoutMessageHelper() {
    ...
    @Override
    public JakartaViewResolver registerDecorator(final String name, final Decorator decorator) {
        registry.registerDecorator(name, decorator);
        return this;
    }

    @Override public JakartaViewResolver setCharset(final Charset charset) {
